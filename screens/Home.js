...
export default class HomeScreen extends Component {
  ...
  getMovie = () => {
    const url = "https://d356-139-5-27-168.ngrok.io/get-movie";
    axios
      .get(url)
      .then(response => {
  ...
  likedMovie = () => {
    const url = "https://d356-139-5-27-168.ngrok.io/liked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  unlikedMovie = () => {
    const url = "https://d356-139-5-27-168.ngrok.io/unliked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  notWatched = () => {
    const url = "https://d356-139-5-27-168.ngrok.io/did-not-watch";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
